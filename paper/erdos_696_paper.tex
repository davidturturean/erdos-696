...
$H(n)/h(n)\to\infty$ for almost all $n$;  he suggested, tentatively, that the normal order of $h(n)$ should be about $\logstar n$. 
...
Erd\H{o}s's prediction for the scale of $h(n)$ is confirmed: $h(n) = \Theta(\logstar n)$ almost always, with leading constant $1/2$.
...
The companion Lean 4 / Mathlib v4.28.0 formalization (about
$1.9 \times 10^4$ lines of Lean source code, $0$ remaining \texttt{sorry}s,
$3$ classical analytic-number-theory inputs admitted as axioms) was produced
by Claude Opus 4.7 (Max Thinking) running inside Claude Code, mirroring the
present manuscript section by section.  The formalization is hosted at
\url{https://github.com/davidturturean/erdos-696} and was finalized on
May 1, 2026.
...
Graduate Texts in Mathematics \textbf{74}, 2nd edition revised by H.~L.~Montgomery,
Springer-Verlag, Berlin Heidelberg, 1980 (softcover reprint of the 1980 hardcover;
ISBN 978-1-4757-5927-3 (eBook)).
